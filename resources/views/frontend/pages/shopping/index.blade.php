                                    ...
                                    <td>
                                        ...
                                        <p>
                                            ...
                                            @if ($item->options->price_old)
                                                <span style="text-decoration: line-through;">{{  number_format(number_price($item->options->price_old),0,',','.') }} VNĐ</span>
                                                <span class="sale" style="color: red"> <b> {{ number_format($item->options->sale,0) }} % </b></span>
                                            @endif
                                        </p>
                                    </td>
                                    <td>
