			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						...
						<span class="info-box-number">{{ number_format($totalMoneyDay,0,',','.') }} VNĐ<small></small></span>
					</div>
					<!-- /.info-box-content -->
				</div>
				<!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{number_format($totalMoneyMonth,0,',','.')  }} VNĐ <small></small></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($totalMoneyYear ,0,',','.') }} VNĐ <small></small></span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                ...
                                                <li>SDT: {{ $transaction->tst_phone }}</li>
                                            </ul>
                                        </td>
