		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group" id="time">
					...
					<input type="text" class="form-control" name="hsd" id="hsd">
				</div>
			</div>
		</div>
	</div>
	<div class="col-md-10">
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group" id="time">
					<label for="exampleInputEmail1">Ngày sản xuất</label>
					<input type="text" class="form-control" name="nsx2" id="nsx2">
				</div>
			</div>
			<div class="col-md-2">
				<div class="form-group" id="time">
					<label for="exampleInputEmail1">Hạn sử dụng</label>
					<input type="text" class="form-control" name="hsd2" id="hsd2">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-10">
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group" id="time">
					<label for="exampleInputEmail1">Ngày sản xuất</label>
					<input type="text" class="form-control" name="nsx3" id="nsx3">
				</div>
			</div>
			<div class="col-md-2">
				<div class="form-group" id="time">
					<label for="exampleInputEmail1">Hạn sử dụng</label>
					<input type="text" class="form-control" name="hsd3" id="hsd3">
				</div>
			</div>
		</div>
	</div>
